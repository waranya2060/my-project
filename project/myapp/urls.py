...
urlpatterns = [
    ...
    path('teacher/add-news/', add_news, name='teacher_news'),

    # Projects overview (manager ใช้ร่วม path นี้)
    ...
    # Manager only
    path('manager/import-members/', import_members, name='import_members'),
